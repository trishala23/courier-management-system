...
<link rel="stylesheet" href="css/icon-font.min.css" type='text/css' />
  ...
  <link href="css/style.css" rel="stylesheet">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form action="" method="post">
            ...
            <button type="submit" class="btn btn-default" name="user_register">Submit</button>
          </form>
        </div>
        ...
        <p>
  		Already a member? <a href="user/index.php"><strong>Sign in<strong></a>
    </p>
      </div>
...
if(isset($_REQUEST['user_register']))
{
  ...
  $email=$_REQUEST['email'];
    ...
    $sql=mysqli_query($conn,"INSERT INTO `corporate` (`user_id`, `password`, `address`,`email`) VALUES ('$user_id', '$password', '$address','$email')");
