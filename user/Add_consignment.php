			...
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
					<input type="text" class="form-control1" name="shippername" placeholder="Sender Name" required="" id="dearname">
							</div>
						</div>
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="shipperaddress" placeholder="Enter sender addrerss" required="" id="dearname">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="date" class="form-control1" name="dateofbooking" placeholder="Enter date" required="" id="dearname">
							</div>
						</div>
						<div class="form-group">
